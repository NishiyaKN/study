...
if (isset($_POST['submit'])) {
    ...
    // Cria um novo id
    $id_arr = mysqli_query($mysqli, "select id_forn from forncedor order by id_forn desc");
    $id_old = mysqli_fetch_array($id_arr);
    $id = $id_old[0] + 1;
    echo $id;
    // Insere os dados no banco 
    $result = mysqli_query($mysqli, "INSERT INTO forncedor VALUES ('$id','$nome', '$endereco', '$cnpj')");
